...
datos %>% 
  ...
  labs(title = "Municipios con mayor y menor carencias por calidad y espacios de vivienda", x = "Municipio", y = "Porcentaje de la población con carencia por calidad y espacios de vivienda", fill = "Estado") +
  coord_flip()
```
